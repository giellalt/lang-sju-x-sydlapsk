...
# Old Literary Southern Sámi language model documentation
...
INTRODUCTION TO MORPHOLOGICAL ANALYSER OF Old Literary Southern Sámi LANGUAGE.

## Definitions for Multichar_Symbols

### Analysis symbols
The morphological analyses of wordforms for the Old Literary Southern Sámi
...
The word forms in Old Literary Southern Sámi language start from the lexeme roots of basic
word classes, or optionally from prefixes:

Adjective inflection
The Old Literary Southern Sámi language adjectives compare.

Noun inflection
Lindahl & Öhrling page XLIVff

Proper noun inflection
The Old Literary Southern Sámi language proper nouns inflect in the same cases as regular
...
Numerals
Numerals in the Old Literary Southern Sámi language describe a nuerical quantity.

Pronouns
Pronouns in the Old Literary Southern Sámi language are words that may replace nouns or refer to participants in the conversation.
...
* __LEXICON PunctMiddle   __ tags punctuation that can be placed in
the middle of some text, with or without space arond,
to indicate a range of something: 9.10.-11.12.2025.
They do not have to be used like this, often they are
not, but only these have this potential.
...
Adjective inflection
The Old Literary Southern Saami language adjectives compare.
...
Prefixes
Prefixes in the Old Literary Southern Saami language are attatched to the left of other words.
...
Proper noun inflection
The Old Literary Southern Saami language proper nouns inflect in the same cases as regular
nouns, but perhaps with a colon (':') as separator.
...
=================================== !
The Old Literary Southern Saami morphophonological/twolc rules file !
=================================== !
...
INTRODUCTION TO MORPHOLOGICAL ANALYSER OF Old Literary Southern Saami LANGUAGE.

## Definitions for Multichar_Symbols

### Analysis symbols
The morphological analyses of wordforms for the Old Literary Southern Saami
language are presented in this system in terms of the following symbols.
(It is highly suggested to follow existing standards when adding new tags).
...
| @U.number.nine@ | Flag used to give arabic numerals in smj different cases ;
| @U.number.zero@ | Flag used to give arabic numerals in smj different cases ;
The word forms in Old Literary Southern Saami language start from the lexeme roots of basic
word classes, or optionally from prefixes:
...
Numerals
Numerals in the Old Literary Southern Saami language describe a nuerical quantity.
...
Proper Nouns
Proper Nouns in the Old Literary Southern Saami language are words that...
...
Pronouns
Pronouns in the Old Literary Southern Saami language are words that may replace nouns or refer to participants in the conversation.
...
We describe here how abbreviations are in Old Literary Southern Saami are read out, e.g.
...
We describe here how abbreviations in Old Literary Southern Saami are read out,
for text-to-speech systems.
...
## tools-analysers-dependency.cg3.md 
...
<small>This (part of) documentation was generated from [tools/analysers/dependency.cg3](https://github.com/giellalt/lang-sju-x-sydlapsk/blob/main/tools/analysers/dependency.cg3)</small>

---

## tools-analysers-functions.cg3.md 
...
<small>This (part of) documentation was generated from [tools/analysers/functions.cg3](https://github.com/giellalt/lang-sju-x-sydlapsk/blob/main/tools/analysers/functions.cg3)</small>
...
##  Old Literary Southern Sámi  G R A M M A R   C H E C K E R
