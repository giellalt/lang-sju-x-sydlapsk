...
do
 ...
 do
      echo "${lemma}${form}" | $HLOOKUP $GTLANGS/lang-sju-x-sydlapsk/src/generator-gt-norm.hfstol # hfst
#      echo "${lemma}${form}" | $LOOKUP $GTLANGS/lang-sju-x-sydlapsk/src/generator-gt-norm.xfst # xfst
 done
 rm -f $L_FILE
done
